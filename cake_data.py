...
# Replace with your actual API URL and authentication details
cakeusd_api_url = "https://api.chainlink.io/v2/jobs/actual_cakeusd_job_id/runs"  # Replace with the actual job ID for CAKE
